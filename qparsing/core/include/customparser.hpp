...
struct Entity{
    ...
    Entity(string key, string name, string orient,
            string eType, string keyword, int column,
            int vFrom,int vTo)
            : key{key}, name{name}, orient{orient}, eType{eType}, keyword{keyword},
            column{column}, vFrom{vFrom}, vTo{vTo} {}
    ...
    Entity(string key, string name, string orient, string eType, 
            ...
            : key{key}, name{name}, orient{orient}, eType{eType}, row{row},
    ...
    Entity(string key, string name, string orient,string eType, 
            ...
            :key{key}, name{name},orient{orient}, eType{eType}, 
