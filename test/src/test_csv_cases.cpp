...
TEST(CSVParserCases, PlantName1) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "PlantName1_inverter.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "PlantName1.csv"));
}
...
TEST(CSVParserCases, Solarlog_Kaco__Inverter) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Solarlog_Kaco__Inverter.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Solarlog_Kaco__Inverter.csv"));
}
...
TEST(CSVParserCases, Solarlog_Kaco__Mppt) {
    ...
    Loc udc{.name = "Udc", .orient = "row", .row = 0};

    Loc idc{.name = "Idc", .orient = "row", .row = 0};
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Solarlog_Kaco__Mppt.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Solarlog_Kaco__Mppt.csv"));
}
...
TEST(CSVParserCases, Solarlog_SMA__Inverter) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Solarlog_SMA__Inverter.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Solarlog_SMA__Inverter.csv"));
}
...
TEST(CSVParserCases, Solarlog_SMA__Mppt) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Solarlog_SMA__Mppt.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Solarlog_SMA__Mppt.csv"));
}
...
TEST(CSVParserCases, Solarlog_ABB__Inverter) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Solarlog_ABB__Inverter.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Solarlog_ABB__Inverter.csv"));
}
...
TEST(CSVParserCases, Solarlog_ABB__Mppt) {
    ...
    Loc pdc{.name = "Pdc1", .orient = "row", .row = 0};

    Loc pdc2{.name = "Pdc2", .orient = "row", .row = 0};

    Loc udc{.name = "Udc1", .orient = "row", .row = 0};

    Loc udc2{.name = "Udc2", .orient = "row", .row = 0};
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Solarlog_ABB__Mppt.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Solarlog_ABB__Mppt.csv"));
}
...
TEST(CSVParserCases, SolarMax__Inverter) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_EXPECTED_DIR + "SolarMax__Inverter.csv"),
              readFile(TEST_CSV_OUTPUT_DIR + "SolarMax__Inverter.csv"));
}
...
TEST(CSVParserCases, SolarMax__Mppt) {
    ...
    ASSERT_EQ(readFile(TEST_CSV_EXPECTED_DIR + "SolarMax__Mppt.csv"),
              readFile(TEST_CSV_OUTPUT_DIR + "SolarMax__Mppt.csv"));
}
...
TEST(CSVParserCases, RCD_Inverter) {
    ...
    ASSERT_EQ(
        readFile(TEST_CSV_EXPECTED_DIR + "RCD_int_kwr_180223_inverter.csv"),
        readFile(TEST_CSV_OUTPUT_DIR + "RCD_int_kwr_180223_inverter.csv"));
}
...
TEST(CSVParserCases, Meteocontrol_Inverter) {
    ...
    Loc id{.name = "Id", .orient = "row", .row = 0};

    Loc ac{.name = "U_AC", .orient = "row", .row = 1};

    Loc udc{.name = "U_DC", .orient = "row", .row = 1};
    ...
    ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Meteocontrol__inverter.csv"),
              readFile(TEST_CSV_EXPECTED_DIR + "Meteocontrol__inverter.csv"));
}
...
TEST(CSVParserCases, Maulevrier_Inverter) {
    ...
    Loc id{.name = "-", .orient = "row", .row = 0};

    Loc Pdc{.name = "Gen.", .orient = "row", .row = 1};

    Loc Pac{.name = "Generated", .orient = "row", .row = 1};
    ...
    // ASSERT_EQ(readFile(TEST_CSV_OUTPUT_DIR + "Maulevrier__inverter.csv"),
    // readFile(TEST_CSV_EXPECTED_DIR + "Maulevrier__inverter.csv"));
}
