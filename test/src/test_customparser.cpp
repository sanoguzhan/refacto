...
TEST(CustomParser, Constructor) {
    ...
    */
    ...
    Entity inverter_ids{.key = "inverter",
                        .name = "INV",
                        .orient = "row",
                        .type = "ids",
                        .row = 0,
    ...
    Entity mppt_ids{.key = "inverter_mppt",
                    .name = "INV",
                    .orient = "row",
                    .type = "ids",
                    .row = 0,
...
TEST(CustomParser, TestInputSize) {
    ...
    */
    ...
    ent.push_back({{"name", "^2001.*98$"}, {"orient", "row"}, {"row", "0"}});
...
TEST(CustomParser, TestTreatedInput) {
    ...
    */
    ...
    Entity pac_watt{.key = "inverter",
                    .name = "Pac_watt",
                    .orient = "row",
                    .type = "series",
                    .row = 0,
                    .value_begin = 1};
    Entity time{.key = "inverter",
                .name = "time",
                .orient = "row",
                .type = "series",
                .row = 0,
...
TEST(CustomParser, TestGroupId) {
    ...
    */
    vector<map<string, string>> ent;
    ent.push_back(
        {{"id", "(.*)_mppt_power_watt"}, {"name", ".*(_mppt_power_watt)"}});
    ...
    p("data/csv/input/test_id_group/", ";", 0);
